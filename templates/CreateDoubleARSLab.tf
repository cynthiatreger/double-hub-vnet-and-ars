...
resource "azurerm_windows_virtual_machine" "Hub1VM" {
  name                  = "Hub1VM"
  resource_group_name   = azurerm_resource_group.RG1.name
  location              = var.region1
...
resource "azurerm_windows_virtual_machine" "Branch1VM" {
  name                  = "Branch1VM"
  resource_group_name   = azurerm_resource_group.RG1.name
  location              = var.region1
  size                  = "Standard_DS2_v2"
...
resource "azurerm_windows_virtual_machine" "Hub2VM" {
  name                  = "Hub2VM"
  resource_group_name   = azurerm_resource_group.RG2.name
  location              = var.region2
  size                  = "Standard_DS2_v2"
...
resource "azurerm_windows_virtual_machine" "Branch2VM" {
  name                  = "Branch2VM"
  resource_group_name   = azurerm_resource_group.RG2.name
  location              = var.region2
  size                  = "Standard_DS2_v2"
